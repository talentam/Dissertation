...
from SiameseNetworkDense import SiameseDenseNetwork
...
model_type = "FNN"
model_name = 'SiameseDense_hidlayer6_256unit_lr10-5_Focal_gamma2_alpha0.5_test'
...
train_set_path = "./dataset/train_ADASYN_new.csv"
...
# save the loss and accuracy in each epoch
